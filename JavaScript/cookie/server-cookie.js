...
Cookie.prototype.httpOnly = true; // 不允许客户端操作Cookie，可一定程度上避免xss攻击
Cookie.prototype.sameSite = false; // strict 不允许本站内向第三方网站发起的请求中携带Cookie。可一定程度上避免csrf攻击
Cookie.prototype.secure = false; 
Cookie.prototype.overwrite = false; // 是否重新该路径上的cookie

// signed 再发送一个name.sig的cookie 对值进行签名，再下一次接收该cookie时，检测是否被篡改。
